...
class ApiUrl {
  ...
  // static String liveBaseURL = 'https://5e9b-49-249-44-114.in.ngrok.io';
  ...
  static String myFollowers = liveBaseURL + '/api/follow/myFollowers';
  static String myFollowings = liveBaseURL + '/api/follow/myFollowing';
}
