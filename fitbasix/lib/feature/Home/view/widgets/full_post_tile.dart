                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      int.tryParse(widget.comments)! > 5
                          ? Obx(() => (_homeController.post.value.comments! /
                                      5 >
                                                              ...
                                                              IconButton(
                                                                  onPressed:
                                                                    ...
                                                                    if (!isReplyLoading &&
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        _homeController.future = _homeController.fetchReplyComment(
                                                                            commentId:
                                                          ...
                                                          _homeController
                                                              ...
                                                              _homeController
                                                                  .commentsList[
                                                                      index]
                                                                  .id!;
                                                          _homeController.viewReplies!.replaceRange(
                                                              0,
                                                              _homeController
                                                                  .viewReplies!
                                                                  .length,
