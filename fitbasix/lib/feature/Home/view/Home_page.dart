...
class _HomePageState extends State<HomePage> {
  ...
  Future<bool> onWillPop() async {
    ...
    if (currentBackPressTime == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text('close_app_text'.tr),));
  ...
  Future<void> onTrendingPostRefresh() async {
    _homeController.initialPostData.value = await HomeService.getPosts(skip: null);

    if (_homeController.initialPostData.value.response!.data!.length != 0) {
      _homeController.trendingPostList.value = _homeController.initialPostData.value.response!.data!;
    }
