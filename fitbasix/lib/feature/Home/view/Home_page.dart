          ...
          child: Obx(
                ...
                MenuScreen(
                    ...
                    name: homeController.userProfileData.value.response == null
                        ? ""
                        : homeController
                        .userProfileData.value.response!.data!.profile!.name!.capitalize
                        .toString(),
                    imageUrl: homeController.userProfileData.value.response ==
                        null
                        ? ""
...
class _HomePageState extends State<HomePage> {
  ...
  final ReportAbuseController _reportAbuseController = Get.put(
  ...
  Future<bool> onWillPop() async {
    ...
    if (currentBackPressTime == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('close_app_text'.tr),));
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                    onTap: () async {
                                      final ProfileController _profileController = Get
                                          .put(ProfileController());
                                      refreshProfileData();

                                      _profileController.setAssetDataForGallery();
                                      _profileController.directFromHome.value =
                                      true;
                                      Navigator.pushNamed(
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  _homeController.userProfileData
                                                      .value
                                                      .response ==
                                                      null
                                                      ? Container()
                          ...
                          Obx(() =>
                          _homeController.userProfileData.value.response!.data!
                              .profile!.isPreviousEnrolled == true
                              ? Container()
                              : Container(
                            child: Column(
                              children: [
                      ...
                      Obx(() =>
                      _homeController.showLoader.value
                          ? Positioned(
                          bottom: 20,
                          left: Get.width / 2 - 10,
                          child:
                      ...
                      Obx(() =>
                      showUserSearch.value ? GestureDetector(
                        onTap: (){
                          clearUserSearchData();
                        },
                        child: Container(
  ...
  void gotoIndividualPage(int index,String trainerId) async{
    ...
    if(_homeController.searchUsersData[index].trainerType!=null){
      ...
      var result =
          await TrainerServices.getATrainerDetail(trainerId);
