...
ActivePlansModel activePlansModelFromJson(String str) =>
    ActivePlansModel.fromJson(json.decode(str));

String activePlansModelToJson(ActivePlansModel data) =>
...
class ActivePlansModel {
  ...
  factory ActivePlansModel.fromJson(Map<String, dynamic> json) =>
      ActivePlansModel(
        code: json["code"],
...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
        ...
        planDetails: List<PlanDetail>.from(
            json["subscriptionData"].map((x) => PlanDetail.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "message": message,
        "subscriptionData":
            List<dynamic>.from(planDetails!.map((x) => x.toJson())),
      };
}
...
class PlanDetail {
  ...
  factory PlanDetail.fromJson(Map<String, dynamic> json) => PlanDetail(
      ...
      invoicePdf: json["invoicePdf"],isActive: json["isActive"]);
...
class Trainer {
  ...
  Map<String, dynamic> toJson() =>
      {"name": name, "profilePhoto": profilePhoto, "id": id};
}
