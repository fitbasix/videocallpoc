...
class CustomDatePickerWidget extends StatefulWidget {
  ...
  CustomDatePickerWidget({Key? key, this.currentDate, this.onChanged})
      : super(key: key);
        ...
        children: [
          Row(
            ...
            children: List.generate(7, (index) {
              List<DateTime> date = getDaysInBetween(widget.currentDate!,
                  widget.currentDate!.add(Duration(days: 6)));
              return Container(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          new DateFormat("E").format(date[index]),
