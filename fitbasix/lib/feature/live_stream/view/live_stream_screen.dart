                        ...
                        suffixIcon: GestureDetector(
                          onTap: () {
                            _liveStreamController
                                ...
                                0
                                ? _liveStreamController.isSearchActive.value =
                            false
            ...
            children: [
             ///date selector and trending posts
              Container(
                ...
                child: Column(
                 ...
                 children: [
                   ...
                   Padding(
                       padding: EdgeInsets.only(left: 16*SizeConfig.widthMultiplier!,bottom: 17*SizeConfig.heightMultiplier!,top: 15*SizeConfig.heightMultiplier!),
                       child: Text(DateFormat.MMMM().format(DateTime.now()),style: AppTextStyle.NormalBlackTitleText,)),
                   ///date changer
                   CustomDatePickerWidget(currentDate: DateTime.now(),onChanged: (selectedDate){
                   ...
                   Padding(
                       padding: EdgeInsets.only(left: 16*SizeConfig.widthMultiplier!,bottom: 10*SizeConfig.heightMultiplier!,top: 15*SizeConfig.heightMultiplier!),
                       child: Text("trending_posts".tr,style: AppTextStyle.NormalBlackTitleText,)),
                 ],
             ),
              ),
              ...
              TrendingPostUI(
                onTap: (){
                  //if user is not live
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ScheduledLiveInformationScreen(
                    imageUrl: "https://www.slazzer.com/static/images/home-page/banner-orignal-image.jpg",
                  )));
                },
                isAccountLive: false,
                hitLike: (hitLike){
