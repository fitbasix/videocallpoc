...
class EditPersonalInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     appBar: AppBarForAccount(title: "Personal Information",parentContext: context,),
      body: Padding(padding: EdgeInsets.symmetric(horizontal: 16*SizeConfig.widthMultiplier!,),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            SizedBox(height: 28*SizeConfig.heightMultiplier!,),
            Text("email".tr,style: AppTextStyle.normalPureBlackTextWithWeight600,),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                contentPadding: EdgeInsets.fromLTRB(12*SizeConfig.widthMultiplier!, 14*SizeConfig.heightMultiplier!, 0, 14*SizeConfig.heightMultiplier!),
            ...
            //user phone no field
            Text("mobile_no".tr,style: AppTextStyle.normalPureBlackTextWithWeight600,),
            SizedBox(height:11*SizeConfig.heightMultiplier!),
            //text field Phone no
            Obx(
                  () => CutomizedTextField(
            ...
            //Date of birth field
            SizedBox(height: 16*SizeConfig.heightMultiplier!,),
            Text("date_of_birth".tr,style: AppTextStyle.normalPureBlackTextWithWeight600,),
            SizedBox(height:11*SizeConfig.heightMultiplier!),
            //text field for user email
            Row(
              children: [
                ...
                SvgPicture.asset(ImagePath.calanderIcon,color: kPureBlack,height: 22*SizeConfig.imageSizeMultiplier!,)
              ],
            ),
            ...
            Container(
              margin: EdgeInsets.only(top: 32*SizeConfig.heightMultiplier!),
                ...
                child: ElevatedButton(
                    ...
                    }, child: Text("change details".tr,style: AppTextStyle.boldWhiteText,))),
